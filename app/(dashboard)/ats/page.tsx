export default function AtsPage() {
  return (
    <div className="max-w-3xl mx-auto flex flex-col gap-5">
      ...
      <button
        className="self-start px-6 py-3 bg-[#22d3a5] text-[#04120e] text-sm font-semibold rounded-lg transition-opacity hover:opacity-90"
        style={{ fontFamily: 'var(--font-mono), monospace', boxShadow: '0 0 20px rgba(34,211,165,0.25)' }}
      >
        check score →
      </button>
    </div>
